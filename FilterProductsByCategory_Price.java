...
public class FilterProductsByCategory_Price {
    ...
    public static void main(String[] args) {
        ...
        // List products
        List<WebElement> products_Name = driver.findElements(By.xpath("//div[@class='KzDlHZ']"));
        List<WebElement> product_Prices = driver.findElements(By.xpath("//div[@class='Nx9bqj _4b5DiR']"));//Nx9bqj _4b5DiR

        int count = Math.min(products_Name.size(), product_Prices.size());
        ...
        for (int i = 0; i < count; i++) {
            // Re-locate product and price elements inside the loop to avoid stale references
